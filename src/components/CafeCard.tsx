    ...
    >
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 bg-gradient-to-t from-black/70 to-transparent w-full p-4">
          <span className="text-white font-bold">{cafe.distance}</span>
        </div>
        <div className="absolute top-2 right-2 bg-white rounded-full px-2 py-1 flex items-center shadow-md">
          ...
          <span className="ml-1 text-sm font-medium">{cafe.note}</span>
        </div>
      </div>
      <div className="p-4">
        <h3 className="text-xl font-bold text-gray-800 mb-1">{cafe.nom}</h3>
        <p className="text-gray-600 text-sm mb-2">{cafe.adresse}</p>
        ...
        <p className="text-gray-700 mb-4 line-clamp-2 h-10">{cafe.description}</p>
